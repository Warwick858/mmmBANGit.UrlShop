...
using mmmBANGit.UrlShop.Shorten.Bitly;
using NUnit.Framework;
using System.Net.Http;
using System.Net.Http.Headers;

namespace mmmBANGit.UrlShop.Shorten.Tests.Bitly
{
	/// <summary>
	...
	public class BitlyClientTests
	{
		...
		public void Setup()
		{
			...
			{
				RetryLimit = 3,
				BitlyUsername = "<username_here>",
				BitlyPassword = "<password_here>",
				BitlyUrl = "https://api-ssl.bitly.com/v4/bitlinks",
				BitlyAuthUrl = "https://api-ssl.bitly.com/oauth/access_token"
			};

			_httpClient = new HttpClient();
			_httpClient.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
			_bitlyClient = new BitlyClient(_appSettings, _httpClient);
		} // end method
		...
		{
			var shortenedUrl = _bitlyClient!.ShortenUrl(url);
